...
of your equity portfolio for daily monitoring as well as monitoring stock prices that you are interested in to e.g. find the right time to purchase. In spite of being interactive (switch UI content by clicking), it is designed to be a static screen that does not require user action by default.
...
1. [Exchangerate.host](hhttps://github.com/Formicka/exchangerate.host) for up-to-date real-time currency conversion as provided by European Central Bank.
2. Bloomberg's
